...
from login_window import LoginWindow  # Import LoginWindow for transitioning
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap("assets/main_background.jpg")  # Ensure this file exists
    ...
    def open_evidence_upload(self):
        ...
        try:
            from evidence_upload_window import EvidenceUploadWindow  # Import inside function

...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap("/home/sariel/Desktop/Automated_Forensics_Software/UI/assets/evidence_backgroun.jpg")  # Ensure this file exists
    ...
    def open_evidence_upload(self):
        ...
        try:
            from UI.evidence_upload_window import EvidenceUploadWindow  # Import inside function
            self.evidence_window = EvidenceUploadWindow()
            self.evidence_window.show()
            self.close()  # Close Main Window after opening the new one
        except Exception as e:
            print(f"Error opening Evidence Upload Window: {e}")

if __name__ == "__main__":
    # This block should only be used for testing the window in isolation
